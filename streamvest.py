...
def get_tickers():
    return ['PETR4.SA - Petrobras', 'VALE3.SA - Vale', 'ITUB4.SA - Itau Unibanco',
        ...
        'BNB-USD - Binance Coin', 'XRP-USD - Ripple','XVG-USD - Verge','MANA-USD - Decentraland', 'ADA-USD - Cardano', 'SOL-USD - Solana',
        'DOGE-USD - Dogecoin','ICP-USD - Internet Computer Protocol', 'DOT-USD - Polkadot', 'AVAX-USD - Avalanche', 'UNI-USD - Uniswap',
...
st.title('Análise da Frequência de Preços de Ativos Financeiros 📊')
